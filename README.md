...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `31.6µs` | `643.5µs` |
| [Day 2](./src/bin/02.rs) | `26.8µs` | `26.0µs` |
| [Day 3](./src/bin/03.rs) | `71.8µs` | `48.1µs` |
| [Day 4](./src/bin/04.rs) | `99.7µs` | `99.0µs` |
| [Day 5](./src/bin/05.rs) | `20.2µs` | `25.9µs` |
